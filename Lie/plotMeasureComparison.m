...
fileNameJLT = sprintf('GEM_%s_N%d_M%d',optimizer,N,M);
saveCal = true;
loadCal = true;

disp('Start calibration under P')
[paramsJLT,errCalJLT,dWPJLT,tJLT,tIndJLT,ctimeCalJLT]=calibrateP(months,T,N,M,Rgan,...
                                    'Optimizer',optimizer,...
                                    'saveCal',saveCal,...
                                    'loadCal',loadCal,...
...
fileNameExp = sprintf('GEM_%s_N%d_M%d',optimizer,N,M);
saveCal = true;
loadCal = true;

disp('Start calibration under P')
[paramsExp,errCalExp,dWPExp,tExp,tIndExp,ctimeCalExp]=calibrateP(months,T,N,M,Rgan,...
                                    'Optimizer',optimizer,...
                                    'saveCal',saveCal,...
                                    'loadCal',loadCal,...
