...
fprintf(inputFile,...
        '\t\\input{%s}\n',changeSlash(latexFilePath));
%% Plots of Change of Measure comparison
fprintf(inputFile,...
        '\\subsection{JLT vs Exp change of measure}\n');
fprintf(inputFile,...
        '\\subsubsection{Under $\\mathbb{P}$}\n');
latexFilePath=saveFigures(traPlotP,'comP',['ComP','_',identifier]);
fprintf(inputFile,...
        '\t\\input{%s}\n',changeSlash(latexFilePath));
fprintf(inputFile,...
        '\\subsubsection{Under $\\mathbb{Q}$}\n');
latexFilePath=saveFigures(traPlotQ,'comQ',['ComQ','_',identifier]);
fprintf(inputFile,...
        '\t\\input{%s}\n',changeSlash(latexFilePath));
%% Appendix
fprintf(inputFile,...
